...
###############################################################################
# Extra Credit Exercises 1-2:                                                 #
# sasdata connections and saspy convenience methods                           #
###############################################################################

# Lines 13-15 load modules needed for exercises and should be left as-is
...
###############################################################################
#                                                                             #
# Extra Credit Example 1. [Python w/ saspy] Connect directly to a SAS dataset #
#                                                                             #
...
# )
# fish_sds = sas.dataframe2sasdata(
#   fish_df_gsa,
#   table="fish_sds_gsa",
#   libref="Work"
# )
...
#    connection to a SAS session, and its sasdata
#    method is used to create the connection to sashelp.fish.
#
# 3. The fish_sds object calls its _convenience method_ means, which implicitly
#    invokes PROC MEANS on sashelp.fish.
#
# 4. For extra credit, try the following:
#    * Explore the additional convenience methods listed at
...
###############################################################################
#                                                                             #
# Extra Credit Example 2.                                                     #
# [Python w/ saspy] Get SAS code generated by a convenience method            #
#                                                                             #
# Instructions: Uncomment the code immediately below, and then execute        #
#                                                                             #
###############################################################################
...
# Notes:
# 1. The SASdata object fish_sds, which was created in a cell above as a direct
#    connection to the SAS dataset sashelp.fish, calls its _convenience
#    method_ means within a "Teach Me SAS" sandwich, and the following is
#    printed:
#    * the SAS code for the PROC MEANS step implicitly generated by the means
#      convenience method
#
# 2. The sas object, which was created in a cell above, is a persistent
#    connection to a SAS session, and its teach_me_SAS method is used as
#    follows:
...
#    code using the submit method (as in Example 9).
